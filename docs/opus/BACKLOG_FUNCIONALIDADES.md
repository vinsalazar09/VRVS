...
## ✅ Concluído (Sprint Dez/2025)

- [x] Consolidação 16 → 9 abas
- [x] Caderno v2 (áreas colapsáveis)
- [x] Diário padronizado (colapsável por área/tema)
- [x] Analytics unificado
- [x] Botão "Mostrar Contexto" nas tarefas
- [x] Gráficos com agrupamento de Traumas
- [x] Toggles no gráfico de linha (checkboxes)
- [x] Radar transparente
